...
export const SCARF_DOMAINS = {
  STATUS: {
    ...
    prevent: "Mutual respect, public acknowledgment, clear career pathways",
  },
  CERTAINTY: {
    name: "Certainty",
    color: "#6CADC3",
    ...
    prevent: "Clear strategies, steady expectations, defined timelines",
  },
  AUTONOMY: {
    name: "Autonomy",
    color: "#AAC785",
    ...
    prevent: "Collaborative decision-making, openness to new ideas, supporting unique strengths",
  },
  RELATEDNESS: {
    name: "Relatedness",
    color: "#AB84BB",
    ...
    prevent: "Building connections, reciprocity, vulnerability, empowerment",
  },
  FAIRNESS: {
    name: "Fairness",
    color: "#000000",
    ...
    prevent: "Transparency, consistent clear standards, reciprocity, care",
  },
};
