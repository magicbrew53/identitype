...
export const SCENARIOS = [
    ...
    choices: [
      {
        ...
        gains: { status: 0, certainty: 0, autonomy: 0, relatedness: 0, fairness: 0 },
      },
      {
      ...
      {
        label: "Offer to recap it yourself",
        type: "Voice",
        consequence: "You say, \"Sarah — since you missed the setup, let me take sixty seconds. Alex hit one piece; there's a detail that changes the recommendation.\" The skip-level says, \"Please.\" You re-explain, cleanly. Alex nods. The action item gets reassigned to the right version of the work, with your name on it.\n\nIt wasn't free. You spent a small amount of social capital to take back the airtime. You'll feel the energy of that choice for the next hour. But the work landed, accurately, attributed correctly. That's not nothing.",
        monologue: "I felt my chest tighten and named the move I was about to make before I made it. That half-second of noticing is the entire difference between fight and voice — same situation, same stakes, different part of my brain in charge. I didn't correct Alex; I served Sarah. That reframe is what made it possible to speak without the threat-response heat coming through. The cost is the energy of staying regulated when my biology wanted to react. The gain is that my work, and my name on it, made it into the room. This is what prefrontal cortex online actually looks like, and it's a muscle, not a personality trait.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 2, fairness: 0 },
        gains: { status: 12, certainty: 6, autonomy: 8, relatedness: 4, fairness: 6 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Pivot the room back to the data",
        type: "Voice",
        consequence: "You say, \"Thanks — happy to dig into any of these numbers.\" You don't soften, you don't sharpen. You open the door to substantive questions. The VP, who didn't expect to be invited deeper, asks a real one. The room shifts from style to substance.\n\nThe earlier comment doesn't get addressed — but it also stops being the loudest thing said. The meeting ends on your findings, not on his framing of you.",
        monologue: "I noticed the sentence land wrong and ran a fast triage: name it now and own the last five minutes of the meeting, or center the work and own its next ten. I chose the work. That's not avoidance — that's where my power actually is in this room. I redirected a moment of threat by widening the frame. My prefrontal cortex stayed online because I had a move ready before I needed one. That's the difference between regulation and suppression — one is a skill, the other is just swallowing.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 1, fairness: 2 },
        gains: { status: 12, certainty: 4, autonomy: 6, relatedness: 2, fairness: 4 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Ask for a feedback structure, not examples",
        type: "Voice",
        consequence: "You say, \"I appreciate that — and I want to grow from it. Could we agree that going forward, anything like this gets raised in our 1:1 as it happens? That way I can adjust in real time instead of receiving it aggregated months later.\"\n\nYour manager pauses. She wasn't expecting a process ask. She says, \"That's fair.\" It's not a fix — the word \"intense\" is still in the file. But you just installed a small safeguard against the next piece of feedback being equally invisible. And you did it without making her defensive.",
        monologue: "I couldn't fight the feedback — it had no surface to push back on. But I could change the system around it. The reframe was: don't argue this specific item, structure the next one. That's where voice lives in unfalsifiable situations — not in the dispute, in the design. My amygdala wanted to demand examples. My prefrontal cortex chose to install a safety rail. One of those moves makes me the problem; the other makes me a partner in solving it.",
        costs: { status: 2, certainty: 2, autonomy: 0, relatedness: 0, fairness: 2 },
        gains: { status: 10, certainty: 8, autonomy: 12, relatedness: 4, fairness: 10 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Restructure the call upfront",
        type: "Voice",
        consequence: "At the next question, instead of letting it bounce off Dan, you say, \"Since these are getting pretty technical — I'll take those directly, and Dan can layer in strategy. Dan, jump in on anything I miss.\" The client blinks, then asks her question to you. She does that for the rest of the call. Dan looks slightly off-balance but recovers and adds value on the strategy questions.\n\nYou spent ten seconds of social interruption to redesign the call. The cost was a small disruption of the existing dynamic. The gain was forty-five minutes of being seen as the expert you actually are.",
        monologue: "I named roles instead of correcting instances. That's a systems move — every micro-correction would have cost me capital each time. Defining the structure once was cheaper than negotiating it twenty times. The trick was offering Dan something real, not just demoting him. He gets to be valuable; I get to be visible. That's what voice can do that fight can't: change the rules of the game instead of just winning the next play.",
        costs: { status: 3, certainty: 0, autonomy: 0, relatedness: 2, fairness: 1 },
        gains: { status: 14, certainty: 6, autonomy: 10, relatedness: 6, fairness: 8 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Reset the introduction with warmth",
        type: "Voice",
        consequence: "You laugh lightly and say, \"I'll take 'new person' — beats some of the alternatives. For the record, since it came up: I've been on this workstream since January, and on the team a fair bit longer than that.\" Two people smile. The stakeholder who called you \"the new person\" looks slightly embarrassed but recovers.\n\nYour name lands correctly in the room and stays there. The meeting picks up. The next time someone refers to your work, they get it right.",
        monologue: "I used humor as a delivery mechanism for the correction. That's regulation in action — I noticed the threat, ran the calculation, and picked the lightest tool that would still land the truth. Self-deprecation is risky if overused; once, it's just charisma. The frame I held: this room is going to know my name when it leaves, and I'm choosing the warmest way to make that happen. My prefrontal cortex picked the move because my amygdala wasn't allowed to run the meeting.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 0, fairness: 1 },
        gains: { status: 12, certainty: 4, autonomy: 8, relatedness: 10, fairness: 6 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Decline the vague, accept the principle",
        type: "Voice",
        consequence: "You say, \"I appreciate you flagging it. Without specifics, I can't course-correct meaningfully. Here's what I can commit to: I'll keep noticing my tone, and if anything concrete comes up, I'd ask you to bring it to me directly so I can hear it in context. I'd also ask we hold any future feedback like this to specific moments.\"\n\nShe pauses. She says, \"Okay.\" She doesn't love it. But you didn't dismiss the principle — you declined to absorb a phantom. The next time, the feedback will either be specific (which you can use) or it won't happen at all.",
        monologue: "I accepted the principle and declined the absorption. That distinction is everything. Arguing with the feedback itself would have been defensive — playing into the \"intense\" frame. Just absorbing it would have meant silencing myself based on rumor. Voice was the third path: stay on the principle of growth, refuse to be governed by anonymity. My prefrontal cortex picked that move because it had a script ready. Without one, I'd have frozen or fought.",
        costs: { status: 3, certainty: 2, autonomy: 1, relatedness: 2, fairness: 0 },
        gains: { status: 12, certainty: 10, autonomy: 18, relatedness: 6, fairness: 14 },
      },
    ],
  },
  ...
  // ─────────── CERTAINTY ───────────
  {
    ...
    choices: [
      ...
      {
        label: "Negotiate the information channel forward",
        type: "Voice",
        consequence: "You message her: \"Totally get the policy on timing. Going forward, can we agree that for changes that affect my projects, I get a heads-up in our 1:1 the same week leadership knows, even if I can't act on it yet? Just enough that I'm not building plans on a foundation that's about to shift.\"\n\nShe pauses, then says, \"Yeah, that's fair.\" You can't recover this morning's lost planning hours. But you just installed a small upstream signal that might save next quarter's.",
        monologue: "I couldn't fix the past two hours, but I could shape the next two months. That's the move voice makes — it trades the unfixable for a process improvement. The amygdala wants to relitigate; the prefrontal cortex builds infrastructure. I named what I needed without making her wrong, and now there's a small commitment on the table she'll either keep or break visibly. Either way, I have information. That's what certainty actually means: not knowing the future, knowing the shape of the loop.",
        costs: { status: 2, certainty: 2, autonomy: 0, relatedness: 1, fairness: 0 },
        gains: { status: 6, certainty: 14, autonomy: 10, relatedness: 8, fairness: 6 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Offer to help fix the reprioritization process",
        type: "Voice",
        consequence: "You say, \"Happy to pivot — and can I propose we also look at how upstream signal could give us a heads-up? Three pivots this quarter has a real context-switch cost. Would be useful to surface that to leadership.\" Your manager looks at you for a half-second differently. She says, \"Bring it to our 1:1 tomorrow.\"\n\nThat's the closest thing to a yes you've gotten on a systems concern in months. You absorbed the pivot — and planted a seed for changing the pattern.",
        monologue: "I named the cost of churn without naming a villain. That's the move — same data, different frame. Complaining gets you labeled resistant; proposing makes you sound like a partner. I'm not sure she'll follow through. But I got an opening. The amygdala wanted to vent; the prefrontal cortex pitched a meeting. The difference is whether the company hears the signal or just hears me.",
        costs: { status: 1, certainty: 2, autonomy: 0, relatedness: 0, fairness: 0 },
        gains: { status: 8, certainty: 14, autonomy: 12, relatedness: 6, fairness: 10 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Ask what the discussion is meant to add",
        type: "Voice",
        consequence: "You say, \"To make sure I'm contributing where it counts — what's the discussion meant to add at this point? Implementation, communication, risk-spotting?\" The facilitator pauses. He says, \"Honestly — communication. We want to make sure people are aligned when this rolls out.\"\n\nThat's an honest answer. The meeting changes shape. People start raising legitimate communication concerns. The hour gets reclaimed for the thing it actually is.",
        monologue: "I didn't expose the dynamic — I redefined it. By asking what the meeting was actually for, I let them tell me, and once they told me, the meeting became that thing instead of pretending to be something else. That's a voice move you can only make with a regulated brain — the amygdala would have either accused them of theater or sat silent. The prefrontal cortex offered a third path: make the room useful by naming what's actually possible in it.",
        costs: { status: 3, certainty: 0, autonomy: 0, relatedness: 1, fairness: 2 },
        gains: { status: 10, certainty: 16, autonomy: 14, relatedness: 8, fairness: 10 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Map the gap, not the promotion",
        type: "Voice",
        consequence: "You say, \"Can we do something specific — map what I'm doing now against next-level criteria? Not for this quarter, just so we both have the same picture of where the gap is and what would close it.\" She hesitates. Then says, \"Yeah, let's do that next 1:1.\"\n\nIt's not a promotion. It's not even a promise. But it's a commitment to a conversation that has shape — and shape is the thing that's been missing.",
        monologue: "I asked for a map, not a destination. That's deliberately small — small enough she could agree to it without committing to a path. The amygdala wanted to threaten leaving. The prefrontal cortex picked the move that gave her room to say yes. Now there's a future meeting with structure, and either she shows up to it or I learn something definitive about whether the destination exists at all. Either way, I'm out of the fog.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 0, fairness: 0 },
        gains: { status: 10, certainty: 14, autonomy: 12, relatedness: 6, fairness: 12 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Propose a clarity deadline",
        type: "Voice",
        consequence: "You message her: \"I want to invest the rest of this quarter well. Can we set a clarity date — by end of month, we either have confirmed budget and launch, or I redirect this capacity to something else? Happy to do the legwork to surface what's needed.\" She responds within an hour: \"Yes. Let's aim for the 25th.\"\n\nFor the first time in two weeks, you know what you're working toward — even if it's just a date by which the fog has to lift.",
        monologue: "I gave her a deadline by giving her permission to set one. Naming a redirect option made it easier for her to commit to a date, because the alternative was me drifting. The amygdala wanted to demand answers; the prefrontal cortex offered a structure where answers had to appear. That's the voice move — design the next step so it gets taken, instead of waiting for someone to design it for you.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 0, fairness: 1 },
        gains: { status: 8, certainty: 18, autonomy: 14, relatedness: 4, fairness: 8 },
      },
    ],
  },
  ...
  // ─────────── AUTONOMY ───────────
  {
    ...
    choices: [
      ...
      {
        label: "Propose a default for low-stakes decisions",
        type: "Voice",
        consequence: "When the meeting finally happens, you say, \"Can we set a default for approvals like this? Anything that isn't budget, headcount, or cross-team, I move on and flag in our weekly sync. Both of us get our time back, and you still have visibility.\" She thinks about it. \"Let's try it for a month.\"\n\nShe approves the actual decision in thirty seconds. The bigger win is the new working agreement — you just solved one approval and a thousand future ones in the same conversation.",
        monologue: "I solved this approval and a year of them in the same move. The reframe: don't ask for this thing to be approved faster; ask for the bucket of things like it to skip the queue entirely. That gives her control through visibility, not through approval, and gives me autonomy through default, not through asking. Prefrontal cortex doing systems design. The amygdala would have just chased the meeting harder and gotten the same one approval at the same cost.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 0, fairness: 0 },
        gains: { status: 6, certainty: 10, autonomy: 18, relatedness: 6, fairness: 12 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Triage the meetings with your manager",
        type: "Voice",
        consequence: "You message her: \"Want to be useful in all six — but two conflict with the deep-focus blocks I use to actually deliver. Can we identify the most essential synchronous, and convert the others to async doc reviews? I'll commit to same-day turnaround on the async ones.\" She thinks. \"Yeah — let's do the two project syncs in person and async the rest.\"\n\nYou just clawed back four hours per week without declining a single meeting.",
        monologue: "I didn't decline anything. I proposed that not everything needed to be a meeting. That's the move — meet the requestor's actual goal (alignment) without accepting the requestor's chosen format (synchronous attendance). The amygdala wanted to defend the calendar; the prefrontal cortex offered alignment via different mechanics. The trick is that I didn't make her feel rejected — I just gave her another way to get what she said she wanted.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 1, fairness: 0 },
        gains: { status: 6, certainty: 8, autonomy: 20, relatedness: 6, fairness: 10 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Propose a two-week trial with data",
        type: "Voice",
        consequence: "You send a short note: \"I'd like to trial this tool for two weeks on a single, non-critical workflow. I'll bring back time-savings data and we can decide formally then. No central systems involved.\" Your manager responds: \"If it's just that scope, fine — keep me posted.\"\n\nTwo weeks later you have data, and a quiet path to formalization that didn't require a tooling-governance meeting.",
        monologue: "I bypassed the governance theater by making the trial smaller than it could refuse. The reframe: don't ask for permission to use a new tool; ask for permission to gather data about a new tool. Almost no one says no to data. Then the data does the asking for you. Prefrontal cortex playing chess. The amygdala would have either chased the approval process or used the tool in secret — both of which leave me carrying the cost.",
        costs: { status: 1, certainty: 0, autonomy: 0, relatedness: 0, fairness: 0 },
        gains: { status: 6, certainty: 10, autonomy: 20, relatedness: 6, fairness: 8 },
      },
    ],
  },
  ...
  // ─────────── RELATEDNESS ───────────
  {
    ...
    choices: [
      ...
      {
        label: "Reframe with an invitation",
        type: "Voice",
        consequence: "You post: \"Counter-take — 'weird food' just means food the meme-writer hasn't tried yet. Hard-launching the office kitchen this Thursday: bring something weird-on-purpose and we make it lunch.\" Three reactions in a minute. Two people sign up. Someone tags two more.\n\nThe meme thread quietly cools. The conversation shifts to who's bringing what Thursday. You used the platform that just made you feel small to plant something that builds.",
        monologue: "I refused to play the role the room offered me — either offended person or good sport. I named the frame and rebuilt it as an invitation. That's a higher-difficulty voice move — you can only make it with regulation, because anger doesn't write warm Slack posts. The prefrontal cortex picked the move that turned a moment of erasure into a moment of belonging on my terms. It cost a small bit of vulnerability. It bought me a Thursday I would have spent eating at my desk.",
        costs: { status: 1, certainty: 0, autonomy: 0, relatedness: 2, fairness: 0 },
        gains: { status: 6, certainty: 4, autonomy: 8, relatedness: 18, fairness: 8 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Bridge with a specific invitation",
        type: "Voice",
        consequence: "You say, \"Different kind of weekend on my end — went to a community event I help organize. Third time going alone, which is fine, but next time I'd love some company. Anyone curious?\" Two people lean in and ask questions. One says, \"I'd actually go.\"\n\nYou just built a bridge by being specific instead of summarizing — and by adding a door someone could walk through.",
        monologue: "I shared and invited in one move. Most of the time when I \"share something real,\" it lands as a curiosity — a thing they file. By adding an invitation, I gave them somewhere to put it: not \"interesting note about me\" but \"I was invited to a thing.\" The amygdala wanted to keep playing the listener role. The prefrontal cortex picked vulnerability with a follow-up. The asymmetry of this team is real — but I just changed it by one human in one direction.",
        costs: { status: 1, certainty: 0, autonomy: 0, relatedness: 2, fairness: 0 },
        gains: { status: 4, certainty: 4, autonomy: 8, relatedness: 18, fairness: 4 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Redirect to a concrete request",
        type: "Voice",
        consequence: "You say, \"I appreciate that. What would actually help me most isn't visibility *of* my difference — it's sponsorship *into* rooms where I haven't been included yet. Could you make sure my name comes up in the next staffing conversation for that workstream? Not as advocacy — just as part of the consideration set.\"\n\nShe blinks. Then says, \"Yes. I'll make that happen this week.\" She wanted to be a good ally. You gave her a way to actually be one. Both of you came out ahead.",
        monologue: "I redirected her need for ally-credit into a concrete ask. That's voice doing real work — instead of managing her feelings, I gave her a job. The amygdala wanted to either smile flatly or call out the performativity. The prefrontal cortex saw a third path: take the goodwill that exists and aim it. The trick was being concrete enough that she couldn't gracefully decline. Now there's a specific commitment, and either she keeps it or the next conversation gets to be about why she didn't.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 1, fairness: 0 },
        gains: { status: 10, certainty: 8, autonomy: 12, relatedness: 12, fairness: 10 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Name the drift, schedule it properly",
        type: "Voice",
        consequence: "You say, lightly, \"Hey — looks like you've got a lot going on. Genuinely was in the middle of something I'd like to finish — can we put fifteen minutes on the calendar today?\" He looks up, slightly caught. \"Yeah — actually yes. End of day work?\"\n\nYou have a calendar block by lunch. The check-in stops being something performed in a hallway and becomes something you both opted into. He shows up that afternoon and actually listens.",
        monologue: "I converted a failed informal moment into a successful scheduled one. Most people don't do this because it feels like overhead for a casual interaction. But the truth is the casual interaction failed — I was about to carry it for the rest of the day. Naming it and scheduling it was the prefrontal-cortex move: redesign the format so the connection can actually happen. The amygdala would have either chased him or shut down. Voice picked the practical thing that worked for both of us.",
        costs: { status: 1, certainty: 0, autonomy: 0, relatedness: 1, fairness: 0 },
        gains: { status: 4, certainty: 4, autonomy: 8, relatedness: 18, fairness: 6 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Re-ask, sharper and more specific",
        type: "Voice",
        consequence: "You reply to your own original post: \"Following up — I think I framed this too broadly. The specific decision I'm trying to make is whether to use approach A or B for the X case. Anyone with hands-on experience either way?\" Three replies within ten minutes.\n\nThe follow-up reads as professional refinement, not a social cry. The answers you get are actually useful. The earlier silence stops being the loudest data point in your day.",
        monologue: "I rewrote the ask instead of relitigating it. That's the move — treat the silence as data about the question, not as data about me. Whether or not that was actually the cause, that frame let me act. The amygdala wanted to delete the post or DM specific people. The prefrontal cortex chose to iterate publicly. The risk was that it might fail again. It didn't, and now I have a slightly different relationship with that channel — I can ask, and ask again, and not die from one quiet hour.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 2, fairness: 0 },
        gains: { status: 6, certainty: 8, autonomy: 10, relatedness: 16, fairness: 6 },
      },
    ],
  },
  ...
  // ─────────── FAIRNESS ───────────
  {
    ...
    choices: [
      ...
      {
        label: "Ask for the unwritten playbook",
        type: "Voice",
        consequence: "You email her: \"Helpful context — can you map what visibility actually means in practice? Specific people, specific forums? I'd rather invest where it counts than guess based on instinct.\" She responds with a real list — three names, two forums you didn't know existed.\n\nThe criteria are still unwritten. But for the first time, someone has named them out loud, in writing, in a message you can refer to.",
        monologue: "I asked for the map by treating it as a professional development question, not a fairness complaint. That reframe is what got me a real answer. The amygdala wanted to demand transparency about the calibration meeting. The prefrontal cortex asked for the operating manual and got it. The unfairness is still there — but now at least I know the actual game. That's not justice. It is information, and information is the start of changing terms.",
        costs: { status: 1, certainty: 0, autonomy: 0, relatedness: 0, fairness: 0 },
        gains: { status: 10, certainty: 14, autonomy: 12, relatedness: 4, fairness: 12 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Score against both, separately",
        type: "Voice",
        consequence: "You say, \"Happy to use the new framework going forward. For this project specifically — can we score it against both? Old criteria for committed scope, new criteria for forward direction. That gives a fair read on six months of work and a clean baseline for the next quarter.\"\n\nThe VP thinks. \"Yeah, do it that way.\" You didn't argue against the new framework. You preserved the integrity of the work that was done under the old one. Two scoreboards instead of one retroactive replacement.",
        monologue: "I separated past from future. The new framework can govern what comes next without being applied violently to what already happened. That distinction is what fairness actually looks like — not \"no new rules,\" but \"rules that respect when they started.\" The amygdala wanted to defend the project. The prefrontal cortex defended the principle. Defending principles in business meetings works better than defending self-interest, even when they're the same thing.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 0, fairness: 0 },
        gains: { status: 10, certainty: 12, autonomy: 12, relatedness: 4, fairness: 16 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        label: "Ask to be in the visible consideration pool",
        type: "Voice",
        consequence: "You say, \"I appreciate the intent. Two things going forward: please ask me directly, even if you think the answer is no. And — I'd like my name to be in the visible consideration pool for stretch work, even when it doesn't land. That matters for how others see who's available.\"\n\nShe pauses. Says, \"Fair. I'll make sure of it.\" You'll see in two months whether it's true. But the ask is now on record — and it wasn't accusatory, just specific.",
        monologue: "I asked for visibility in the pool, not just consideration in her head. That's the structural fix — if I'm only on her private list, only she knows I'm a candidate. If I'm visibly in the pool, other people can suggest me too. The amygdala wanted to be hurt about the past project. The prefrontal cortex designed a system where the next one is less likely to slip past me. Whether she keeps her word is the test; either way, I'm now in a position to notice.",
        costs: { status: 2, certainty: 0, autonomy: 0, relatedness: 1, fairness: 0 },
        gains: { status: 12, certainty: 10, autonomy: 14, relatedness: 6, fairness: 18 },
      },
    ],
  },
];
